...
1. If the question is about **current config** (what MCP servers, models, or settings are active),
   read `/Users/wuxiao40/.grok/config.toml`. MCP servers are under `[mcp_servers.*]` sections.
...
2. If the question is about **how to do something** (setup, adding MCP servers, creating skills,
   ...
   `/Users/wuxiao40/.grok/docs/user-guide/`. The available guides are:
   ...
   `/Users/wuxiao40/.grok/README.md` for the comprehensive reference.

3. To **modify config** for the user, edit `/Users/wuxiao40/.grok/config.toml` with search_replace.

4. To **create a skill** for the user, create `/Users/wuxiao40/.grok/skills/<name>/SKILL.md`
   (read `/Users/wuxiao40/.grok/docs/user-guide/08-skills.md` for the SKILL.md format).